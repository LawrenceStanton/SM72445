/**
 ******************************************************************************
 * @file			: SM72445_X.test.cpp
 * @brief			: Test functions for miscellaneous SM72445 methods.
 * @author			: Lawrence Stanton
 ******************************************************************************
 * @note Most tests have been refactored into their own files in this directory.
 */
...
TEST_F(SM72445_X_Test, convertAdcResultToPinVoltageNormallyConvertsValue) {
...
TEST(SM72445_X_GainTest, getGainNormallyReturnsCorrespondingGainValue) {
...
TEST(SM72445_X_GainTest, getGainReturnsZeroIfGivenPropertyInvalid) {
	SM72445_X sm72445Gain{
		*(SM72445::I2C *)(nullptr),
		DeviceAddress::ADDR001,
		1.0f,
